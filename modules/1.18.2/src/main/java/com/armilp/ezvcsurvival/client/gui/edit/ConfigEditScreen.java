...
public class ConfigEditScreen extends Screen {
    ...
    private static Component getTitleComponent(EditType editType, String elementName) {
        switch (editType) {
            case ENTITY_CONFIG:
                return new TranslatableComponent("screen.ezvcsurvival.entity_config_edit", elementName);
            case GENERAL_SOUND_CONFIG:
                return new TranslatableComponent("screen.ezvcsurvival.general_sound_config_edit", elementName);
            case GENERAL_SOUND_ENTITY:
                return new TranslatableComponent("screen.ezvcsurvival.general_sound_entity_edit", elementName);
            case GUNFIRE_ENTITY:
                return new TranslatableComponent("screen.ezvcsurvival.gunfire_entity_edit", elementName);
            default:
                return new TranslatableComponent("screen.ezvcsurvival.config_edit");
        }
    }
    ...
    private void initFields(int centerX, int startY) {
        ...
        enabledButton = new Button(
                ...
                new TranslatableComponent(enabled ? "button.ezvcsurvival.enabled" : "button.ezvcsurvival.disabled"),
                b -> toggleEnabled()
        );
        this.addRenderableWidget(enabledButton);
        currentY += FIELD_SPACING + 20;

        speedBox = new EditBox(this.font, centerX - CENTER_X_OFFSET, currentY, FIELD_WIDTH, FIELD_HEIGHT, new TextComponent(""));
        ...
        rangeBox = new EditBox(this.font, centerX - CENTER_X_OFFSET, currentY, FIELD_WIDTH, FIELD_HEIGHT, new TextComponent(""));
        ...
        if (editType == EditType.ENTITY_CONFIG) {
            thresholdBox = new EditBox(this.font, centerX - CENTER_X_OFFSET, currentY, FIELD_WIDTH, FIELD_HEIGHT, new TextComponent(""));
        ...
        if (editType == EditType.GENERAL_SOUND_CONFIG) {
            priorityButton = new Button(
                    centerX - CENTER_X_OFFSET, currentY, FIELD_WIDTH, FIELD_HEIGHT,
                    new TranslatableComponent(isPriority ? "button.ezvcsurvival.priority_on" : "button.ezvcsurvival.priority_off"),
                    b -> togglePriority()
            );
        ...
        if (editType == EditType.GENERAL_SOUND_ENTITY) {
            soundFiltersButton = new Button(
                    centerX - CENTER_X_OFFSET, currentY, FIELD_WIDTH, FIELD_HEIGHT,
                    new TextComponent("Sound Filters..."),
    ...
    private void initActionButtons(int centerX, int startY) {
        ...
        this.saveButton = new Button(
                ...
                new TranslatableComponent("button.ezvcsurvival.save"),
                b -> saveConfig()
        );
        ...
        Button cancelButton = new Button(
                ...
                new TranslatableComponent("button.ezvcsurvival.cancel"),
        ...
        Button resetButton = new Button(
                ...
                new TranslatableComponent("button.ezvcsurvival.reset"),
                b -> resetToDefaults()
        );
    ...
    private void toggleEnabled() {
        enabled = !enabled;
        enabledButton.setMessage(new TranslatableComponent(enabled ? "button.ezvcsurvival.enabled" : "button.ezvcsurvival.disabled"));
        updateSaveButtonState();
    }

    private void togglePriority() {
        isPriority = !isPriority;
        priorityButton.setMessage(new TranslatableComponent(isPriority ? "button.ezvcsurvival.priority_on" : "button.ezvcsurvival.priority_off"));
        updateSaveButtonState();
    }
    ...
    private void updateSaveButtonState() {
        if (saveButton != null) {
            ...
            if (hasChanges) {
                saveButton.setMessage(new TranslatableComponent("button.ezvcsurvival.save"));
            } else {
                saveButton.setMessage(new TranslatableComponent("button.ezvcsurvival.no_changes"));
            }
        }
    }

...
@EventBusSubscriber(modid = EZVCSurvival.MOD_ID, bus = EventBusSubscriber.Bus.GAME, value = Dist.CLIENT)
public class SoundEventHandler {
    ...
    public static void onPlaySound(PlaySoundEvent event) {
        ...
        // En NeoForge 1.21.1, simplemente usamos PacketDistributor.sendToServer()

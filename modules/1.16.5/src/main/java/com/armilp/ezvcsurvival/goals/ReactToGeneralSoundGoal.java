...
public class ReactToGeneralSoundGoal extends Goal {
    ...
    public static Vector3d lastPrioritySoundPos = null;
    ...
    private Vector3d targetSoundPos = null;
    ...
    public ReactToGeneralSoundGoal(MobEntity mob, double speed, double range, List<SoundGroupData> soundGroups) {
        ...
        this.isMonster = mob instanceof MonsterEntity;
    }

    public void onSoundPlayed(ResourceLocation soundLoc, Vector3d soundPos, double speedMult, double rangeMult) {
    ...
    public static void setPrioritySound(Vector3d position) {

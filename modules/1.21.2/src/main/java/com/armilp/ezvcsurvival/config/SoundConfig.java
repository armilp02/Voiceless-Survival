...
public class SoundConfig {
    ...
    public static void registerConfigListeners(IEventBus modEventBus) {
        modEventBus.addListener(SoundConfig::onModConfigLoading);
        modEventBus.addListener(SoundConfig::onModConfigReloading);
    }

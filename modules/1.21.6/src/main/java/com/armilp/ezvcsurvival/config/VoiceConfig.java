...
public class VoiceConfig {
    ...
    public static final ModConfigSpec.DoubleValue SCULK_SENSOR_THRESHOLD;
    public static final ModConfigSpec.IntValue SCULK_SENSOR_RANGE;
    public static final ModConfigSpec.IntValue SCULK_SENSOR_FREQUENCY;

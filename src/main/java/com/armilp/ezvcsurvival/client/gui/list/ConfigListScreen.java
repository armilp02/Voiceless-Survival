...
public class ConfigListScreen extends Screen {
    ...
    public ConfigListScreen(ListType listType, Screen parent) {
        super(new TranslatableComponent(getTitleKey(listType)));
    ...
    protected void init() {
        ...
        backButton = new Button(
                ...
                new TranslatableComponent("button.ezvcsurvival.back"),
        ...
        if (listType == ListType.GENERAL_SOUNDS_CONFIG) {
            toggleViewButton = new Button(
                    ...
                    new TranslatableComponent(showingSounds ? "button.ezvcsurvival.show_entities" : "button.ezvcsurvival.show_sounds"),
                    b -> toggleView()
            );
        ...
        refreshButton = new Button(
                ...
                new TranslatableComponent("button.ezvcsurvival.refresh"),
                b -> refreshData()
        );
        ...
        searchBox = new EditBox(this.font, leftMargin, searchRowY, searchWidth, SEARCH_HEIGHT,
                new TranslatableComponent("textbox.ezvcsurvival.search"));
    ...
    private void toggleView() {
        ...
        toggleViewButton.setMessage(new TranslatableComponent(showingSounds ? "button.ezvcsurvival.show_entities" : "button.ezvcsurvival.show_sounds"));
    ...
    private Component getToggleEnabledMessage() {
        ...
        return new TranslatableComponent(isEnabled ? "button.ezvcsurvival.disable_all" : "button.ezvcsurvival.enable_all");
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        this.font.draw(poseStack, new TranslatableComponent("gui.ezvcsurvival.search"),
    ...
    private Component getCountComponent() {
        if (listType == ListType.ENTITY_CONFIG || listType == ListType.GUNFIRE_CONFIG) {
            return new TranslatableComponent("gui.ezvcsurvival.entity_count", list.children().size());
        } else if (listType == ListType.GENERAL_SOUNDS_CONFIG) {
            if (showingSounds) {
                return new TranslatableComponent("gui.ezvcsurvival.sound_count", list.children().size());
            } else {
                return new TranslatableComponent("gui.ezvcsurvival.entity_count", list.children().size());
            }
        }
    ...
    private Component getInstructionsComponent() {
        if (listType == ListType.ENTITY_CONFIG || listType == ListType.GUNFIRE_CONFIG) {
            return new TranslatableComponent("gui.ezvcsurvival.click_to_edit_entity");
        } else if (listType == ListType.GENERAL_SOUNDS_CONFIG) {
            if (showingSounds) {
                return new TranslatableComponent("gui.ezvcsurvival.click_to_edit_sound");
            } else {
                return new TranslatableComponent("gui.ezvcsurvival.click_to_edit_entity");
            }
        }
